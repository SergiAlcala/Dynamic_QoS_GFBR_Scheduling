...
main(int argc, char* argv[])
{
    ...
    cmd.AddValue("CGgbrDL", "The GBR to be configured for the CG traffic in bps. Default is 0, which means that the CG traffic will be configured with the same GBR as the VR traffic.", CGgbrDL);
    cmd.AddValue("Datarate", "The datarate to be configured for the video traffic generator in Mbps. Default is 5 Mbps.", Datarate);
    cmd.Parse(argc, argv);
